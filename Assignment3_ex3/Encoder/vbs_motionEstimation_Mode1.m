function [motionVectors, avgMAE,vbs_matrix] = vbs_motionEstimation_Mode1(mode, currentFrame,originalReferenceFrames, interpolatedReferenceFrames, blockSize, searchRange, dct_blockSize,QP,lambda,FMEEnable, FastME)
