function [motionVectors, avgMAE,vbs_matrix] = vbs_motionEstimation_Mode2(mode, currentFrame,originalReferenceFrames, interpolatedReferenceFrames, blockSize, searchRange, dct_blockSize,QP,lambda,FMEEnable, FastME)
